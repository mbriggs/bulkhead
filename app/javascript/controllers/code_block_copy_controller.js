...
// rendered rich text. Wraps each <pre> in a relative container and
...
export default class extends Controller {
  ...
  async copy(pre, btn) {
    ...
    btn.innerHTML = '<span class="code-copy-confirmation">Copied!</span>'
    setTimeout(() => { btn.innerHTML = original }, 1500)
  }

  // Heroicon mini clipboard-document (16x16).
  get copyIconSvg() {
    return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="code-copy-icon">
